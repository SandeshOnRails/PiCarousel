module.exports = function (app,crypto) {
	 ...
	 app.get('/admin', function(req, res){
	 	...
	 	console.log("password admin: "+crypto.cipher('secretKey', 'admin', 'aes256'));
	 	console.log("password : admin"+crypto.decipher('secretKey', crypto.cipher('secretKey', 'admin', 'aes256')));
